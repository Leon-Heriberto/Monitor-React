...
import useFetchGraphic from "../hooks/useFetchGraphic";
...
export const SalesValueChart = () => {
  ...
  const {data} = useFetchGraphic(`http://${pathRoute}/monitor/stator/graphic-realtime`)
  // TODO Add Hook to fetch data
  // const data = {
  //   labels: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
  //   series: [[1, 2, 2, 3, 3, 4, 3]]
  // };

  localStorage.setItem("TotalRealTime", data['total'])
